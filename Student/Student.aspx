    ...
    <form id="form1" runat="server">
        ...
        <div runat="server" class="divCheck" id="CheckActDiv">
            <div class="auto-style13">
                <asp:Label runat="server" Text="活动申请详情" Font-Bold="True" Font-Size="Large"></asp:Label></div>
            ...
            <table class="auto-style12" style="vertical-align: middle">
                ...
                <tr>
                    <td>
                        <asp:Label ID="LblActName" runat="server"></asp:Label></td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="LblActInfo" runat="server"></asp:Label></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="LblHoldDate" runat="server"></asp:Label></td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="LblSignDate" runat="server"></asp:Label></td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="LblMaxSize" runat="server"></asp:Label></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="BtnCheck" runat="server" Text="返回" CssClass="auto-style11" OnClick="BtnCheck_Click" Width="60px" CausesValidation="False" /></td>
                </tr>
            </table>
        </div>
        ...
        <div class="divInfo" runat="server" id="DivMyInfoR">
            ...
            <div style="width: 600px; height: 280px; padding-left: 10px;">
                <ul>
                    <li class="li-style">姓名：<asp:Label ID="LblStuName" runat="server" Text="张三"></asp:Label>
                        <asp:ImageButton ID="ImageButtonInfo" runat="server" OnClick="ImageButtonInfo_Click" ImageUrl="~/image/info.png" Width="15px" Style="margin-left: 5px" ToolTip="信息修改" CausesValidation="False" /></li>
            ...
            <div style="width: 600px; height: 200px; margin-left: 84px; display: none" id="DivChangePsw" runat="server">
                <ul style="list-style-type: none;">
                    ...
                    <li class="li-style">
                        <asp:Label ID="LblMessage" runat="server" ForeColor="#CC0000"></asp:Label></li>
                </ul>
            </div>
                ...
                <div style="width: 630px; height: 300px; overflow: auto">
                    <asp:GridView ID="GvCredit" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="LinqDataSourceCredit" ForeColor="#333333" GridLines="None" PageSize="1" Width="614px" Style="margin-top: 10px" OnDataBound="GvCredit_DataBound" ShowHeader="False">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="activityType" HeaderText="类别" ReadOnly="True" SortExpression="activityType" ItemStyle-Width="40px" ItemStyle-Height="25px"></asp:BoundField>
                            <asp:BoundField DataField="activityName" HeaderText="活动名称" ReadOnly="True" SortExpression="activityName" ItemStyle-Width="310px" ItemStyle-Height="25px"></asp:BoundField>
                            <asp:BoundField DataField="availableCredit" HeaderText="获得学分" ReadOnly="True" SortExpression="availableCredit" ItemStyle-Width="210px" ItemStyle-Height="25px"></asp:BoundField>
                            <asp:BoundField DataField="holdDate" HeaderText="发放时间" ReadOnly="True" SortExpression="holdDate" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="220px" ItemStyle-Height="25px"></asp:BoundField>
                        </Columns>
                        <EditRowStyle BackColor="#999999" />
                        <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                        <HeaderStyle BackColor="#8d9ba5" Font-Bold="True" ForeColor="White" CssClass="head" />
        ...
        <%--组队页面--%>
        <div id="DivBuildTeam" runat="server" style="border-style: solid; border-color: inherit; border-width: 1px; position: absolute; background-color: #F7F6F3; top: 300px; left: 858px; padding: 5px; display: none; width: 250px">
            ...
            <div style="padding: 5px 0px 0px;">
                ...
                <asp:DropDownList ID="DdlBuildTeamAct" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DdlBuildTeamAct_SelectedIndexChanged"></asp:DropDownList>
            </div>
            <div style="padding: 5px 0px 0px;">
                <asp:Label ID="LblTeamName" runat="server" Text="队伍名称："></asp:Label>
                <asp:TextBox ID="TxtTeamName" runat="server" Width="100px"></asp:TextBox>
            </div>  
            <div style="padding: 5px 0px 0px;">
            ...
            <div style="padding: 5px 0px 0px;">
                ...
                <asp:RadioButtonList ID="RblBuildTeam" runat="server" Style="margin-left: 78px; margin-top: -23px;" RepeatDirection="Horizontal">
